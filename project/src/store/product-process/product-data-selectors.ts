...
export const getSuccessStatus = (state: State): boolean => state[NameSpace.ProductData].isSuccess;
export const getReviewLoadingStatus = (state: State): boolean => state[NameSpace.ProductData].isSending;
